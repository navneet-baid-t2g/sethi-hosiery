...
// Get the category and subcategory and subsubcategory from the URL parameters
$categorySlug = isset($_GET['category']) ? $_GET['category'] : '';
$subcategorySlug = isset($_GET['subcategory']) ? $_GET['subcategory'] : '';
$subsubcategorySlug = isset($_GET['subsubcategory']) ? $_GET['subsubcategory'] : '';
